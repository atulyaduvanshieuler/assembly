...
def lambda_handler(event, context):
    ...
    print(emch_number, fork_2_bearing_id)
        ...
        with conn.cursor() as cur:
            ...
            if verification[0]:
                ...
                dbquery="""
                            ...
                            SET fork_2_bearing=sub_query_1.id FROM
                            (SELECT id FROM fork_2_bearings WHERE fork_2_bearing_id=%s) AS sub_query_1,
                ...
                cur.execute(dbquery,(fork_2_bearing_id,emch_number,))
                conn.commit()

                msg = {
                    "message": "fork_2_bearing with fork_2_bearing id: %s updated successfully in vehicle with following EMCH number: %s"
