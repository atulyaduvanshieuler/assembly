...
def lambda_handler(event, context):
    ...
    print(emch_number, aux_battery_id)
        ...
        with conn.cursor() as cur:
            ...
            if verification[0]:
                ...
                dbquery="""
                            ...
                            SET aux_battery=sub_query_1.id FROM
                            (SELECT id FROM aux_batteries WHERE aux_battery_id=%s) AS sub_query_1,
                ...
                cur.execute(dbquery,(aux_battery_id,emch_number,))
                conn.commit()

                msg = {
                    "message": "aux_battery with aux_battery id: %s updated successfully in vehicle with following EMCH number: %s"
