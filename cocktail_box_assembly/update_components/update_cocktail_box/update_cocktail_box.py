        ...
        with conn.cursor() as cur:
            ...
            if verification[0]:
                ...
                dbquery="""
                            ...
                            SET cocktail_box=sub_query_1.id FROM
                            (SELECT id FROM cocktail_boxes WHERE cocktail_box_id=%s) AS sub_query_1,
                ...
                cur.execute(dbquery,(cocktail_box_id,emch_number,))
                conn.commit()

                msg = {
                    "message": "cocktail_box with cocktail_box id: %s updated successfully in vehicle with following EMCH number: %s"
