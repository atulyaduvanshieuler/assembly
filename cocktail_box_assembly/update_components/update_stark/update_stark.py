        ...
        with conn.cursor() as cur:
            ...
            if verification[0]:
                ...
                dbquery="""
                            ...
                            SET stark=sub_query_1.id FROM
                            (SELECT id FROM starks WHERE stark_id=%s) AS sub_query_1,
                ...
                cur.execute(dbquery,(stark_id,emch_number,))
                conn.commit()

                msg = {
                    "message": "stark with stark id: %s updated successfully in vehicle with following EMCH number: %s"
