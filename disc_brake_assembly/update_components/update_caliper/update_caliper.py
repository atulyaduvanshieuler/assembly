        ...
        with conn.cursor() as cur:
            ...
            if verification[0]:
                ...
                dbquery="""
                            ...
                            SET caliper=sub_query_1.id FROM
                            (SELECT id FROM calipers WHERE caliper_id=%s) AS sub_query_1,
                ...
                cur.execute(dbquery,(caliper_id,emch_number,))
                conn.commit()

                msg = {
                    "message": "caliper with caliper id: %s updated successfully in vehicle with following EMCH number: %s"
